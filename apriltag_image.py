...
def apriltag_image(input_images=['../media/Test/1.jpg','../media/input/Test.jpg','../media/input/single_tag.jpg', '../media/input/multiple_tags.jpg'],
                   output_images=False,
                   display_images=True,
    ...
    options = apriltag.DetectorOptions(families='tag16h5')  # try this first
