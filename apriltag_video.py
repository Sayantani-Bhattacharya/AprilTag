...
def apriltag_video(input_streams=['../media/input/TAG_PATH.mp4','../media/input/single_tag.mp4', '../media/input/multiple_tags.mp4'], # For default cam use -> [0]
                   output_stream=False,
                   display_stream=True,
    ...
    for stream in input_streams:
        ...
        while(video.isOpened()):
            ...
            # Calibrate your camera and note its intrinsic parameters fx, fy, cx, cy.
